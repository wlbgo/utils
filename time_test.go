...
func TestGetWeekDayStr(t *testing.T) {
	...
	tests := []struct {
		...
		{"TestMon", args{1617225600, 1}, "20210329", false},
		{"TestTue", args{1617225600, 2}, "20210330", false},
		{"TestWed", args{1617225600, 3}, "20210331", false},
		{"TestThu", args{1617225600, 4}, "20210401", false},
		{"TestFri", args{1617225600, 5}, "20210402", false},
		{"TestSat", args{1617225600, 6}, "20210403", false},
		{"TestSun", args{1617225600, 7}, "20210404", false},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := GetWeekDayStr(tt.args.timestamp, tt.args.day)
